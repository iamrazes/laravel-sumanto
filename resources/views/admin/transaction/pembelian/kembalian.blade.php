                ...
                <div class="card-body">
                    <div class="d-flex flex-column ">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <input type="text" class="rounded col-sm-8 bg-transparent border-white text-white text-right" style="height: 40px;" value="{{ $transaksi->id }}" readonly>
                        </div>
                        <div class="d-flex justify-content-between mt-3">
                            <label for="">Tanggal Transaksi</label>
                            <input type="text" class="rounded col-sm-8 bg-transparent border-white text-white text-right" style="height: 40px;" value="
                    {{ $transaksi->created_at->format('l, d m Y') }}" readonly>
                        </div>
                        <div class="d-flex justify-content-between mt-3">
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            ...
                            <input type="number" class="rounded col-sm-8 bg-transparent border-white text-white text-center p-3" name="harga_bayar" style="height: 40px;" placeholder="Masukan nominal uang" value="{{ request()->harga_bayar }}">
                        </div>
                        <div class="d-flex justify-content-between">
                            <label for=""></label>
