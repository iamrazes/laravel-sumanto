          ...
          <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20">Rp.30.000</div>
                      </td>
                    </tr>
                    <tr>
                      <td><a href="pages/examples/invoice.html">OR9842</a></td>
              ...
              <div class="card-footer clearfix">
                ...
                <a href="javascript:void(0)" class="btn btn-sm btn-secondary float-right">History Transaksi</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
